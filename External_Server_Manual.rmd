...
author: "External Server - A Guide for Researchers"
date: "`r Sys.Date()`"
output:
  html_document:
    df_print: paged
...
```{r, echo=FALSE}
library(htmltools)
htmltools::img(src = knitr::image_uri("media/logo.png"), 
               alt = 'logo', 
               style = 'position:absolute; top:0; right:0; padding:10px;height:300px;width:250px')
```
